...
namespace Lector.Sharp.Wpf.Models
{
    public partial class SisFarmaEntities : DbContext
    {
        ...
        private static string BuildConnectionString(string dataSource, string database)
        {
            ...
            var connectionString = $"server={dataSource};user id=fisiotes_admin;password=66408147812;persistsecurityinfo=True;database={database}; Allow Zero Datetime=True; Convert Zero Datetime=True";
